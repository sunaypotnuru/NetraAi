...
mock_analytics = {
    ...
    "success_rates": {
        "tools": [
            {
                "tool": "diagnose_anemia_tool",
                "category": "Hematology",
                "success_rate": 0.978,
                "total_calls": 1250,
                "successful_calls": 1222,
                "failed_calls": 28,
                "avg_latency_ms": 456.23,
            },
            {
                "tool": "detect_cataract_tool",
                "category": "Ophthalmology",
                "success_rate": 0.985,
                "total_calls": 840,
                "successful_calls": 827,
                "failed_calls": 13,
                "avg_latency_ms": 523.45,
            },
            {
                "tool": "screen_dr_tool",
                "category": "Ophthalmology",
                "success_rate": 0.972,
                "total_calls": 620,
                "successful_calls": 603,
                "failed_calls": 17,
                "avg_latency_ms": 678.90,
            },
        ],
...
mock_logs = [
    {
        ...
        "tool_name": ["diagnose_anemia_tool", "detect_cataract_tool", "screen_dr_tool"][
            i % 3
        ],
...
try:
    ...
    print("   📄 File: test_analytics_report.pdf")
    ...
    with open("test_audit_logs.pdf", "wb") as f:
        f.write(pdf_bytes)
    print(f"   ✅ SUCCESS: Generated {len(pdf_bytes):,} bytes")
    print("   📄 File: test_audit_logs.pdf")
...
try:
    ...
    print("   📊 File: test_analytics_report.xlsx")
    ...
    with open("test_audit_logs.xlsx", "wb") as f:
        f.write(excel_bytes)
    print(f"   ✅ SUCCESS: Generated {len(excel_bytes):,} bytes")
    print("   📊 File: test_audit_logs.xlsx")
