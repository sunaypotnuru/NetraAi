...
async def detect_cataract(
    ...
    **kwargs,
    ...
    service_url = os.getenv(
        "CATARACT_SERVICE_URL", "https://sunay-potnuru-netra-cataract.hf.space"
    )
    ...
    severity = ml_result.get("status") or ml_result.get("prediction") or "Normal"
    opacity = ml_result.get("cataract_probability") or ml_result.get("confidence") or 0.0
...
def _get_cataract_recommendation(severity: str) -> str:
    ...
    return recs.get(sev, "Routine follow-up.")
