...
async def test_fhir_ops_patient(mock_supabase):
    ...
    mock_db.table.return_value.select.return_value.eq.return_value.execute.return_value = MagicMock(
        data=[{"data": {"resourceType": "Patient", "id": "11111111-1111-1111-1111-111111111111"}}]
    )

    res = await get_patient_fhir(ctx, patient_id="11111111-1111-1111-1111-111111111111")
...
async def test_fhir_create_observation(mock_supabase):
    ...
    mock_db = MagicMock()
    mock_supabase.return_value = mock_db
    res = await create_fhir_observation(ctx, "718-7", 10.2, "g/dL", "11111111-1111-1111-1111-111111111111")
...
async def test_fhir_query_timeline(mock_supabase):
    ...
    res = await query_patient_timeline(ctx, "11111111-1111-1111-1111-111111111111", "DiagnosticReport")
