...
class TestAnalyticsService:
    ...
    def sample_messages(self, db_session: Session, sample_users):
        ...
        conversations = []
        for i in range(5):
            conv = Conversation(created_at=datetime.utcnow() - timedelta(days=10 - i))
            db_session.add(conv)
    ...
    def test_get_appointment_analytics_basic(
        self, analytics_service, sample_appointments
    ):
    ...
    def test_get_appointment_analytics_by_status(
        self, analytics_service, sample_appointments
    ):
        ...
        assert (
            "scheduled" in by_status
            or "completed" in by_status
            or "cancelled" in by_status
        )
        assert sum(by_status.values()) == result["total_appointments"]

    def test_get_appointment_analytics_rates(
        self, analytics_service, sample_appointments
    ):
    ...
    def test_get_appointment_analytics_daily_trends(
        self, analytics_service, sample_appointments
    ):
    ...
    def test_get_appointment_analytics_peak_hours(
        self, analytics_service, sample_appointments
    ):
    ...
    def test_get_appointment_analytics_avg_per_day(
        self, analytics_service, sample_appointments
    ):
    ...
    def test_get_ai_usage_analytics_basic(
        self, analytics_service, sample_consultations
    ):
    ...
    def test_get_ai_usage_analytics_confidence_distribution(
        self, analytics_service, sample_consultations
    ):
    ...
    def test_get_ai_usage_analytics_avg_confidence(
        self, analytics_service, sample_consultations
    ):
    ...
    def test_get_ai_usage_analytics_daily_trends(
        self, analytics_service, sample_consultations
    ):
    ...
    def test_get_revenue_analytics_calculation(
        self, analytics_service, sample_appointments
    ):
        ...
        expected_revenue = (
            result["completed_appointments"] * result["avg_revenue_per_appointment"]
        )
    ...
    def test_get_revenue_analytics_daily_trends(
        self, analytics_service, sample_appointments
    ):
    ...
    def test_get_system_performance_database_stats(
        self, analytics_service, sample_users
    ):
    ...
    def test_get_messaging_analytics_avg_calculation(
        self, analytics_service, sample_messages
    ):
    ...
    def test_get_messaging_analytics_daily_trends(
        self, analytics_service, sample_messages
    ):
    ...
    def test_get_overview_summary(
        self, analytics_service, sample_users, sample_appointments
    ):
