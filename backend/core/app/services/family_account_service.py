...
class FamilyAccountService:
    ...
    async def add_family_member(
        ...
        member_email = member_data.get("member_email") or member_data.get("email")
        member_name = member_data.get("member_name") or member_data.get("name", "")
        member_user_id = None
        ...
        family_member = {
            ...
            Col.FamilyMembers.PHONE: member_data.get("phone"),
    ...
    async def update_family_member(
        ...
        if "relationship" in update_data and update_data["relationship"]:
            update_data["relationship"] = update_data["relationship"].lower()
