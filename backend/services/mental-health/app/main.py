...
async def predict_mental_health(file: UploadFile = File(...)):
    """Compatibility alias for callers that use the shared ML `/predict` contract."""
    return await analyze_mental_health(file)
